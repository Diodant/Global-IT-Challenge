    ...
    <div>
      ...
      <div className="regulations-container">
        ...
        <div className="regulation-section">
          ...
          <p>1.4 Конкурс проводится ежегодно с 2020 года. Сроки подачи заявки с 1 по 15 августа, подведение итогов 20 августа. </p>
          <p>1.5 Заявки на конкурс принимаются в период с 1 по 20 июля.</p>
        </div>
        <div className="regulation-section">
