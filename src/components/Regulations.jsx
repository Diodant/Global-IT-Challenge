    ...
    <div>
      ...
      <div className="regulations-container">
        ...
        <div className="regulation-section">
          ...
          <p>3.1. Участниками Конкурса могут быть профессиональные IT-специалисты с опытом работы не менее 2-х лет из различных стран, обладающие соответствующими знаниями и навыками.</p>
